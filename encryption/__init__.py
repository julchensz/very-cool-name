...
class C(BaseConstants):
    ...
    NUM_ROUNDS = 3
    TIME_FOR_TASK = 100000  # in seconds
    RANDOM_SEED = 12345678


class Subsession(BaseSubsession):
    random_seed = models.IntegerField()  # make the 'random' words reproducable
    ...
    def setup_round(self):
        ...
        self.word = "".join(random.choices(string.ascii_uppercase, k=5))  # drawing with replacement, output is a list
